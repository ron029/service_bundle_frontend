...
.empty-cart #oval:nth-child(1),
.empty-cart #plus:nth-child(2),
.empty-cart #diamond:nth-child(3),
.empty-cart #bubble-rounded:nth-child(4),
.empty-cart #oval:nth-child(5),
.empty-cart #plus:nth-child(6),
.empty-cart #diamond:nth-child(7),
.empty-cart #bubble-rounded:nth-child(8),
.empty-cart #oval:nth-child(9),
.empty-cart #plus:nth-child(10),
.empty-cart #diamond:nth-child(11),
.empty-cart #bubble-rounded:nth-child(12),
.empty-cart #oval:nth-child(13),
.empty-cart #plus:nth-child(14),
.empty-cart #diamond:nth-child(15),
.empty-cart #bubble-rounded:nth-child(16) {
