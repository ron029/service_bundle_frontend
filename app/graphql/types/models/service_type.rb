module Types
  module Models
    class ServiceType < Types::BaseObject
      ...
      def time_slot(date: nil, start_time: nil, end_time: nil)
        time_slots = object.time_slots
        time_slots = time_slots.where(date: date) if date
        ...
        formatted_time_slots = time_slots.to_a.map do |time_slot|
          {
            ...
            date: time_slot.date.strftime('%Y-%m-%d'), # Format date as 'YYYY-MM-DD'
